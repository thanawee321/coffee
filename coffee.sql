...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 21, 2021 at 05:09 AM
...
(54, 'เข้าสู่ระบบ', 'ทำการเข้าสู่ระบบ', '2021-02-17 18:39:35', 'ADMIN!!'),
(55, 'ออกจากระบบ', 'ทำการออกจากระบบ', '2021-02-17 18:56:09', 'ADMIN!!'),
(56, 'เข้าสู่ระบบ', 'ทำการเข้าสู่ระบบ', '2021-02-17 18:56:17', 'Mr. Thanawee'),
(57, 'เข้าสู่ระบบ', 'ทำการเข้าสู่ระบบ', '2021-02-18 10:49:41', 'Mr. Thanawee'),
(58, 'เข้าสู่ระบบ', 'ทำการเข้าสู่ระบบ', '2021-02-19 10:24:19', 'Mr. Thanawee'),
(59, 'เพิ่มข้อมูล', 'test', '2021-02-19 11:50:59', 'Mr. Thanawee'),
(60, 'เพิ่มข้อมูล', 'test', '2021-02-19 11:55:54', 'Mr. Thanawee'),
(61, 'เข้าสู่ระบบ', 'ทำการเข้าสู่ระบบ', '2021-02-21 10:12:41', 'ADMIN!!'),
(62, 'เปลี่ยนสถานะ', 'อเมริกาโน่ เป็น [status] = 2', '2021-02-21 10:12:59', 'ADMIN!!'),
(63, 'เปลี่ยนสถานะ', 'เอสเปสโส เป็น [status] = 1', '2021-02-21 10:13:19', 'ADMIN!!'),
(64, 'แก้ไขข้อมูล', 'คาปูชิโน่ ไรโน่ 2 สีหมีแพนด้าที่ ID : 1', '2021-02-21 10:14:18', 'ADMIN!!'),
(65, 'แก้ไขข้อมูล', 'ข้าวผัดอเมริกันโน่ที่ ID : 4', '2021-02-21 10:14:31', 'ADMIN!!'),
(66, 'แก้ไขข้อมูล', 'ลูกชิ้นทอดที่ ID : 6', '2021-02-21 10:15:02', 'ADMIN!!'),
(67, 'ลบข้อมูล', 'นมผงเคโคตรด่วย ที่อยู่ใน ID : 9', '2021-02-21 10:55:39', 'ADMIN!!'),
(68, 'เปลี่ยนสถานะ', 'น้ำตาล เป็น [status] = 1', '2021-02-21 11:06:51', 'ADMIN!!'),
(69, 'เปลี่ยนสถานะ', 'น้ำตาล เป็น [status] = 2', '2021-02-21 11:06:58', 'ADMIN!!'),
(70, 'เปลี่ยนสถานะ', 'ผงกัญชา เป็น [status] = 2', '2021-02-21 11:07:08', 'ADMIN!!');
...
(1, 'คาปูชิโน่ ไรโน่ 2 สีหมีแพนด้า', 50, 68, 2),
(3, 'นมเย็น', 0, 15, 1),
(4, 'เอสเปสโส', 50, 55, 1),
(5, 'ม็อกค่า', 40, 50, 1),
(6, 'อเมริกาโน่', 45, 50, 2),
(7, 'ลาเต้', 40, 50, 1),
...
--
ALTER TABLE `material_coffee`
  MODIFY `id_mat_coffee` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
